...
plt.plot(scaler.inverse_transform(scaled_series),label="Deficit")
plt.plot(trainPredictPlot,label="Train Deficit")
plt.plot(testPredictPlot,label="Test Deficit")
